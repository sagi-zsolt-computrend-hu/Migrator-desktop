...
@Slf4j
@Component
public class AkkorDataSourceImpl extends AbstractDataSource {

	@Autowired
	@Getter
	private AkkorDataSourceConfiguration dataSourceConfiguration;
	@Override
...
//	}
	...
	public String getDataSourceInfo() {
		return getDataSourceInfo(dataSourceConfiguration.dataSource(),AkkorDataSourceConfiguration.PREFIX);
	}
